    ...
    const QuizifyApp = {
        async init() {
            try {
                ...
                if (typeof QuizifyProfiler !== 'undefined' && typeof QuizifyProfiler.init === 'function') {
                    QuizifyProfiler.init(this);
                }
...
function showPage(pageId) {
    ...
    if (pageId === 'home-page') {
        ...
        // Render weakness profiler on home page
        if (typeof QuizifyProfiler !== 'undefined' && typeof QuizifyProfiler.renderDashboard === 'function') {
            QuizifyProfiler.renderDashboard();
        }
    }
